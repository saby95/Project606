...
import CrowdMentor.utilities.UserRoles
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[(CrowdMentor.utilities.UserRoles.UserRoles(b'admin'), b'admin'), (CrowdMentor.utilities.UserRoles.UserRoles(b'auditor'), b'auditor'), (CrowdMentor.utilities.UserRoles.UserRoles(b'mentor'), b'mentor'), (CrowdMentor.utilities.UserRoles.UserRoles(b'task_updater'), b'task_updater'), (CrowdMentor.utilities.UserRoles.UserRoles(b'worker'), b'worker')], default=CrowdMentor.utilities.UserRoles.UserRoles(b'worker'), max_length=15)),
